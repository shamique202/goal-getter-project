...
urlpatterns = [
  ...
  # path('courses/<int:courses_id>/update_assignment/<int:assignment_id>/', views.update_assignment, name='update_assignment'),
  # path('courses/<int:courses_id>/delete_assignment/<int:assignment_id>/', views.delete_assignment, name='delete_assignment')
